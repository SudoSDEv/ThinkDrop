...
import com.rescue.blood.instablood.model.UserProfile;
...
public class DonorActivity extends AppCompatActivity{
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(getArguments().getInt(ARG_SECTION_NUMBER)==1) {
                TextView textView = (TextView) rootView.findViewById(R.id.noOfPending);
                textView.setText(Common.pendingReceivers.size() + "");
                RecyclerView recyclerView = rootView.findViewById(R.id.pendingRecceivers);
                recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
                recyclerView.setItemAnimator(new DefaultItemAnimator());
                recyclerView.setAdapter(new RecieverAdapter(getActivity(), recyclerView, Common.pendingReceivers));
                return rootView;
            }
    ...
    public void onBackPressed() {
        ...
        //ReceiverFragmentForDonor.removeLocationUpdates();
        super.onBackPressed();
    }
}
